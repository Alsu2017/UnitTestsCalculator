...
public class SeleniumWaitTests {
    ...
    void loadingImagesImplicitWaitTest() {
        ...
        WebElement picture = driver.findElement(By.id("landscape"));
        assertThat(picture.getAttribute("src")).containsIgnoringCase("land");
    }


    // Ожидание элемента находящегося по ID
    @Test
    void loadingImagesExplicitWaitTest() {
        ...
        assertThat(landscape.getAttribute("src")).contains("land");
    }

    //Всего ждем 10 секунд проверяем каждую секунду
    @Test
