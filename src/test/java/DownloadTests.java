...
class DownloadTests {
    ...
    void testDownloadHttpClient() throws IOException {
        ...
        WebElement pngLink = driver.findElement(By.cssSelector("[href=\"./docs/webdrivermanager.png\"]"));
...
//        WebElement pdfLink = driver.findElement(By.cssSelector("[href=\"./docs/webdrivermanager.pdf\"]"));
